...
[11.py](11.py) inspects 3 representative traces so you can see where the gaussian-like curves overlap well. Try to fit the regions that don't change during the course of an experiment. | ![](12.py)

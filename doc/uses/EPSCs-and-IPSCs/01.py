...
def analyzeSweep(abf,sweep,m1=None,m2=None,plotToo=False):
    ...
    Ymb=np.convolve(Y,Kmb,mode='same')
    Y=Y-Ymb # commit
    ...
    # event detection
    thresh=7 # threshold for an event
...
def analyzeABF(abf):
    ...
    for sweep in range(abf.sweeps):
        #[hitsPos,hitsNeg]=analyzeSweep(abf,sweep=sweep,m1=.3,plotToo=r'C:\Users\swharden\Documents\temp')
        [hitsPos,hitsNeg]=analyzeSweep(abf,sweep=sweep,m1=.3)
...
if __name__=="__main__":
    analyzeABF(r"X:\Data\2P01\2016\2016-09-01 PIR TGOT\16d05020.abf")
    print("DONE")